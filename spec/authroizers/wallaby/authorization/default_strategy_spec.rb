...
describe Wallaby::Authorization::DefaultStrategy do
  ...
  describe '#authorize?' do
    it 'returns true' do
      expect(subject.authorize?(:index, target_class)).to be_truthy
      expect(subject.authorize?(:index, target)).to be_truthy
      ...
      expect(subject.authorize?(:destroy, target)).to be_truthy
    end
  end

  describe '#authorize_field?' do
    it 'returns true' do
      expect(subject.authorize_field?(:index, target_class, :id)).to be_truthy
      expect(subject.authorize_field?(:index, target, :id)).to be_truthy
      ...
      expect(subject.authorize_field?(:destroy, target, :id)).to be_truthy
    end
  end
