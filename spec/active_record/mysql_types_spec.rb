...
describe 'Mysql Types' do
  ...
  it 'supports the following types' do
    ...
    expect(supporting_types.sort).to eq [ "bigint", "binary", "bit", "blob", "boolean", "char", "clob", "date", "datetime", "decimal", "double", "enum", "float", "int", "longblob", "longtext", "mediumblob", "mediumint", "mediumtext", "number", "numeric", "set", "smallint", "text", "time", "timestamp", "tinyblob", "tinyint", "tinytext", "year" ]
  end
end
