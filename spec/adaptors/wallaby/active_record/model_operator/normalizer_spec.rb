...
describe Wallaby::ActiveRecord::ModelOperator::Normalizer do
  ...
  describe '#normalize' do
    describe 'range types' do
      ...
      describe 'numrange' do
        it 'turns array into range' do
          expect(subject.normalize(parameters({ numrange: [ '88', '999' ] }))[:numrange]).to eq '88'...'999'
      ...
      describe 'int4range' do
        it 'turns array into range' do
          expect(subject.normalize(parameters({ int4range: [ '88', '999' ] }))[:int4range]).to eq '88'...'999'
      ...
      describe 'int8range' do
        it 'turns array into range' do
          expect(subject.normalize(parameters({ int8range: [ '88', '999' ] }))[:int8range]).to eq '88'...'999'
    ...
    describe 'point types' do
      it 'turns array into range' do
        expect(subject.normalize(parameters({ point: [ '3', '4' ] }))[:point]).to eq [ 3.0, 4.0 ]
