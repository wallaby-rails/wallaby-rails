  ...
  describe '#user_portrait' do
    ...
    context 'when email_method is configured' do
      it 'returns user gravatar ' do
        ...
        version_specific = {
          5 => {
            2 => '<img class="hidden-xs user" src="http://www.gravatar.com/avatar/4f6994f5bafb573ca145d9e62e5fdfae" />'
          }
        }
        expected = minor version_specific, '<img class="hidden-xs user" src="http://www.gravatar.com/avatar/4f6994f5bafb573ca145d9e62e5fdfae" alt="4f6994f5bafb573ca145d9e62e5fdfae" />'
