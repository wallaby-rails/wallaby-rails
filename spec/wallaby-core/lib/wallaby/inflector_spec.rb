...
describe Wallaby::Inflector do
  ...
  describe '.to_resources_name' do
    it 'handles the namespace and returns resources name for a class name' do
      ...
      expect(described_class.to_resources_name('Wallaby::Post', divider: Wallaby::COLONS)).to eq 'wallaby::posts'
      expect(described_class.to_resources_name('wallaby/posts')).to eq 'wallaby/posts'
      expect(described_class.to_resources_name('wallaby/posts', divider: Wallaby::COLONS)).to eq 'wallaby::posts'
      ...
      expect(described_class.to_resources_name('Wallaby::Person', divider: Wallaby::COLONS)).to eq 'wallaby::people'
      expect(described_class.to_resources_name('wallaby/person')).to eq 'wallaby/people'
      expect(described_class.to_resources_name('wallaby/person', divider: Wallaby::COLONS)).to eq 'wallaby::people'
      expect(described_class.to_resources_name('Wallabies::Person')).to eq 'wallabies/people'
      expect(described_class.to_resources_name('Wallabies::Person', divider: Wallaby::COLONS)).to eq 'wallabies::people'
      expect(described_class.to_resources_name('wallabies/person')).to eq 'wallabies/people'
      expect(described_class.to_resources_name('wallabies/person', divider: Wallaby::COLONS)).to eq 'wallabies::people'
    end
