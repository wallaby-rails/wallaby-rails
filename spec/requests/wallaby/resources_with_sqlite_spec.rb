...
describe 'Resources pages using mysql table' do
  ...
  describe '#index' do
    ...
    it 'renders collections' do
      ...
      get '/admin/all_sqlite_types?q=van&sort=string%20desc'
      expect(response).to be_successful
      expect(response).to render_template :index
      expect(response.body).to include string
  ...
  describe '#create' do
    it 'creates the record' do
      ...
      post '/admin/all_sqlite_types', all_sqlite_type: { string: string }
  ...
  describe '#update' do
    ...
    it 'updates the record' do
      ...
      put "/admin/all_sqlite_types/#{ record.id }", all_sqlite_type: { string: a_string }
