  ...
  describe '.to_resources_name' do
    ...
    context 'when model_class is blank' do
      it 'returns blank string' do
        ...
        expect(described_class.to_resources_name []).to eq ''
        expect(described_class.to_resources_name Hash.new).to eq ''
      end
    end
  end
  ...
  describe '.to_model_label' do
    ...
    context 'when model_class is blank' do
      it 'returns blank string' do
        ...
        expect(described_class.to_model_label []).to eq ''
        expect(described_class.to_model_label Hash.new).to eq ''
      end
    end
  end
  ...
  describe '.to_model_name' do
    ...
    context 'when resources_name is blank' do
      it 'returns blank string' do
        ...
        expect(described_class.to_model_name []).to eq ''
        expect(described_class.to_model_name Hash.new).to eq ''
      end
    end
  end
  ...
  describe '.to_model_class' do
    ...
    context 'when resources_name is unknown' do
      it 'raises ModelNotFound error' do
        expect{ described_class.to_model_class 'unknown_future' }.to raise_error Wallaby::ModelNotFound, 'UnknownFuture'
        expect{ described_class.to_model_class 'unknown_future', 'Caller' }.to raise_error Wallaby::ModelNotFound, 'UnknownFuture from Caller'
      end
    end
    ...
    context 'when resources_name is blank' do
      it 'returns nil' do
        ...
        expect(described_class.to_model_class []).to be_nil
        expect(described_class.to_model_class Hash.new).to be_nil
      end
    end
  end
