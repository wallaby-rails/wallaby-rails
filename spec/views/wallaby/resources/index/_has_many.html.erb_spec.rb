...
describe 'partial' do
  let(:partial)   { 'wallaby/resources/index/has_many.html.erb' }
  let(:value) do
    [
  ...
  let(:metadata)  { Hash.new label: 'Products' }
